...
public class UpdateBarRanges : MonoBehaviour 
{
	...
	void Update () 
	{
		...
		this.GetComponent<Renderer>().material.SetFloat("_TopLine", topLine.position.y);
		this.GetComponent<Renderer>().material.SetFloat("_BottomLine", bottomLine.position.y);
	}
}
